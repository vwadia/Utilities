function params = getDNActivations(pathStimuli, ndim, layer)
...
%     INPUTS:
%         1. Path stimuli
%         2. The number of dimensions to take
%         3. layer pf alexnet to use  eg.'fc6'
%     
%     OUPUTS:
%         1. Params
% vwadia July2021
...
threeD = 1;
grayImages = Utilities.getImageDescriptions(pathStimuli, 227, threeD);
